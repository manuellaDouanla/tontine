                                        ...
                                        <table id="dataTable">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="hidden" name="ID_paiement"
                                                            value="<?php echo $row['ID_paiement']; ?>"></td>
                                                    <td>Nom<input type="text" name="Nom" value="<?php echo $Nom; ?>"
                                                            readonly /></td>
                                                    <td>Date paiement<input type="date" name="Date_paiement"
                                                            value="<?php echo $Date_paiement; ?>" /></td>
                                                    <td>1ere Tranche<input type="number" name="Tranche1" id="tranche1"
                                                            value="<?php echo $Tranche1; ?>" min="0" /></td>
                                                    <td>2eme Tranche<input type="number" name="Tranche2" id="tranche2"
                                                            value="<?php echo $Tranche2; ?>" min="0" /></td>
                                                    <td>Statut du paiement<input type="text" name="Statut_paiement"
                                                            id="statut" value="<?php echo $Statut_paiement; ?>" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <br>
                                        <button type="submit" class="btn btn-info" id="enregistrer"
                                            name="update">Modifier</button>
                                        <a class="btn btn-danger" type="annuler" href="listPaiement.php"><i
                                                class="bi bi-trash"></i>Annuler</a>
