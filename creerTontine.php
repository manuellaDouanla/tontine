                ...
                <div class="card-body">
                    ...
                    <form action="creerTontine.php" method="POST">
                                ...
                                <tr>
                                    <td>
                                        <input class="form-control" type="text" name="code[]"
                                            value="<?php $date= date('Y'); echo 'tontine'. $date ?>"
                                            style="width: 105px;">
                                    </td>
                                    <td>
                                        <select id="nomInput" class="form-control select2" name="nom[]"
                                            style=" width: 200px;">
                                            <option value=""></option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="montant[]"
                                            placeholder="Enter Montant" style=" width: 150px;" min="500">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="ordre[]"
                                            placeholder="Enter ordre" style=" width: 80px;" min="1">
                                    </td>
                                    <td>
                        ...
                        <button type="submit" name="save" class="btn btn-primary"
                            <?php include('enregistrerTontine.php'); ?>>Submit</button>
