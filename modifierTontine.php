                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" id="" value="<?php echo $row['code']; ?>"
                                            required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="montant" id="" value="<?php echo $row['montant']; ?>"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="Téléphone">Ordre énéficiere :</label>
                                        <input type="text" name="ordrebenef" id=""
                                            value="<?php echo $row['ordrebenef']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="Quartier">sanction(2000) :</label>
                                        <input type="number" name="sanctionBenef" id=""
                                            value="<?php echo $row['sanctionBenef']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="Date d'inscription ">sanction(4000) :</label>
                                        <input type="number" name="sanctionNonBenef" id=""
                                            value="<?php echo $row['sanctionNonBenef']; ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
