                ...
                <form action="" method="POST">
                    <?php foreach ($liste as $row):?>
                        ...
                        <div class="form-row">
                            ...
                            <input type="text"  name="prenom"  id = ""  value="<?php echo $row['Prenom']; ?>" required>
                            </div>
                            <div class="form-group">
                            <label for="Téléphone">Téléphone :</label>
                            <input type="text" name="telephone"  id = ""  value="<?php echo $row['Telephone']; ?>" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                            <label for="Quartier">Quartier :</label>
                            <input type="text"  name="quartier"  id = ""  value="<?php echo $row['Quartier']; ?>" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                            <label for="Frais d'adhésion (10.000 FCFA)">Frais d'adhésion (10.000 FCFA) :</label>
