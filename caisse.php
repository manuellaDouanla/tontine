  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Caisse</span>
      </a>
      <i class="bi bi-list toggle-sidebar-btn"></i>
    </div><!-- End Logo -->

    <div class="search-bar">
      <span class="d-none d-lg-block"><h4>Caisse</h4></span>
    </div><!-- End Search Bar -->
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Somme Caisse</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body pb-0">
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    <th>Date</th>
                    <th>Somme/sanction/Benef</th>
                    <th>Somme/sanction/nonBenef</th>
                    <th>Somme/Assurance</th>
                    <th>Frais/Dadhesion</th>
                    <th>Somme/Totale</th>
                  </tr>
                </thead>
                <tbody>
                <?php include('fichier_include/selectCaisse.php'); ?>
                </tbody>
              </table>
