                    ...
                    if (mysqli_num_rows($runsql1) > 0) {
                        while ($row = mysqli_fetch_assoc($runsql1)) {
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-info" href="modifierTontine.php?modifier=<?php echo $row['id_tontine'] ?>"><i class="bi bi-pencil-square"></i></a>
                                    &nbsp;
                                <a href="deleteMember.php?deletes=<?php echo $row['id_tontine'] ?>" onclick="decrement()"><i class="btn btn-danger"><i class="bi bi-trash"></i></i></a>
                                </td>
                            </tr>
                            <?php
                        }
