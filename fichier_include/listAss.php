...
<tr>
    ...
    <td>
        <a class="btn btn-info" type="edit" href="modifAssociation.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-pencil-square"></i></a> 
        <a class="btn btn-danger" type="delete" href="deleteAssociation.php?ID=<?php echo $row['ID']; ?>"><i class="bi bi-trash"></i></a> 
        </td>
        </tr>
<?php  }
    }
