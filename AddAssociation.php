            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body pb-0">
                        <h5 class="card-title">
                            <center>Creer une Association</center>
                        </h5>
                        <div class="accounttype">
                            ...
                            <form action="createAssociation.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="fraisInscription" name="fraisInscription" value="10000"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="plafondAssurance">Plafond d'assurance :</label>
                                    <input type="number" id="plafondAssurance" name="plafondAssurance" value="50000"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="sanctionNonBenef">Sanction de tontine non bénéficiée :</label>
                                    <input type="number" id="sanctionNonBenef" name="sanctionNonBenef" value="4000"
                                        required>
                                </div>
                                <div class="form-group">
