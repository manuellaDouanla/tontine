                ...
                <div class="card">
                    <center>
                        <div class="col-sm-4">
                            ...
                            <h5 class="card-title">
                                <center>redefinir l'Association</center>
                            </h5>
                            <div class="accounttype">
                                <h2>Créer l'association</h2>
                                <form action="editAssociation.php?ID=<?php echo $_GET['ID']; ?>" method="POST"
                                    class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="dateCreation" name="dateCreation" required
                                            value="<?php echo $dateCreation; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="fraisInscription">Frais d'inscription :</label>
                                        <input type="number" id="fraisInscription" name="fraisInscription"
                                            value="<?php echo $fraisInscription; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="plafondAssurance">Plafond d'assurance :</label>
                                        <input type="number" id="plafondAssurance" name="plafondAssurance"
                                            value="<?php echo $plafondAssurance; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="sanctionNonBenef">Sanction de tontine non bénéficiée :</label>
                                        <input type="number" id="sanctionNonBenef" name="sanctionNonBenef"
                                            value="<?php echo $sanctionBenef; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="sanctionBenef">Sanction de tontine déjà bénéficiée :</label>
                                        <input type="number" id="sanctionBenef" name="sanctionBenef"
                                            value="<?php echo $sanctionNonBenef; ?>" required>
                                    </div>
                                    <div class="form-group">
