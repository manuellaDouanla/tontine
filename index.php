              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST"novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="login" value="">Se connecter</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Vous n'avez pas de compte? <a href="register.php">Creer un compte</a></p>
                      <p class="small mb-0"><a href="reset_password.php">Mot de passe oublié ?</a></p>
                    </div>
                  </form>
