                ...
                <form action="addMember.php" method="POST">
                  <table class="table">
                    ...
                    <tbody id="container">
                      <tr>
                        <td>
                          <input type="text" class="form-control input-lg" name="CNI[]" value="" id="" required>
                        </td>
                        <td>
                          <input type="text" class="form-control input-lg" name="nom[]" value="" id="" required>
                        </td>
                        <td>
                          <input type="text" class="form-control input-lg" name="prenom[]" value="" id="" required>
                        </td>
                        <td>
                          <input type="text" class="form-control input-lg" name="quartier[]" value="" id="" required>
                        </td>
                        <td>
                          <input type="text" class="form-control input-lg" name="telephone[]" value="" id="" required>
                        </td>
                        <td>
                          <input type="number" class="form-control input-lg" name="FraisAdhesion[]" value="10000" id="">
                        </td>
                        <td>
