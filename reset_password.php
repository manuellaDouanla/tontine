...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Requête pour vérifier si le nom d'utilisateur existe dans la base de données
    $checkQuery = "SELECT * FROM utilisateurs WHERE username = ?";
    ...
    if ($checkResult->num_rows > 0) {
        // Le nom d'utilisateur existe, mise à jour du mot de passe
        $updateQuery = "UPDATE utilisateurs SET password = ? WHERE username = ?";
        ...
        if ($stmt->execute()) {
            ...
            $error_message = "Une erreur s'est produite lors de la modification du mot de passe. Veuillez réessayer.";
        }
    } else {
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Entrez votre Nom d'utilisateur & votre Mot de passe
                                        </p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" novalidate method="POST">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit" name="register"
                                                value="">Réinitialiser</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Vous n'avez pas de compte? <a
                                                    href="register.php">Creer un compte</a></p>
                                        </div>
                                    </form>
