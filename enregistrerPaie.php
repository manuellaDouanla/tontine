                                ...
                                <td>Nom
                                  <select name="selectMembre[]">
                                    <?php foreach ($membres as $membre): ?>
                                        <option value="<?php echo $membre['Nom'] . ' ' . $membre['Prenom']; ?>">
                                  ...
                                  <td>Date paiement<input type="date" name="Date_paiement[]" value="" /></td>
                                  <td>1ere Tranche<input type="number" name="Tranche1[]" value="0" id="tranche1" min="0"/></td>
                                  <td>2eme Tranche<input type="number" name="Tranche2[]" value="0" id="tranche2" min="0"/></td>
                                  <td>Statut du paiement<input type="text" name="Statut_paiement[]" value="En attente" id="statut" readonly/></td>
                                  <td>Add<a class="btn btn-success" type="add" onclick="addRow()"><i class="bi bi-plus"></i></a></td>
                                  <td>Supress<a class="btn btn-danger" type="delete" onclick="removeRow(this)"><i class="bi bi-trash"></i></a></td>
                                </tr>
                              </tbody>
                            </table>
                        <br>
                        <button type="submit" class="btn btn-primary" name="save" <?php include('fichier_include/insert.php');?>>Enregistrer</button>
                        </form>
                      </div>
                  </div>
              </div>
