<?php
include('fichier_include/addPaie.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h1>Paiement D'assurance</h1>
                                    <form action="enregistrerPaie.php" method="POST" id="votreFormulaire">
                                        <table id="dataTable">
                                            <tbody>
                                                <tr>
                                                    <td>Nom
                                                        <select name="selectMembre[]">
                                                            ...
                                                            <option
                                                                value="<?php echo $membre['Nom'] . ' ' . $membre['Prenom']; ?>">
                                                                <?php echo $membre['Nom'] . ' ' . $membre['Prenom']; ?>
                                                            </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </td>
                                                    <input type="hidden" name="plafondAssurance"
                                                        value="<?php echo '' . $plafondAssurance . '' ?>"
                                                        id="plafondAssurance" readonly />
                                                    <td>Date paiement<input type="date" name="Date_paiement[]"
                                                            value="" /></td>
                                                    <td>1ere Tranche<input type="number" name="Tranche1[]" value="0"
                                                            id="tranche1" min="0" /></td>
                                                    <td>2eme Tranche<input type="number" name="Tranche2[]" value="0"
                                                            id="tranche2" min="0" /></td>
                                                    <td>Statut du paiement<input type="text" name="Statut_paiement[]"
                                                            value="En attente" id="statut" readonly /></td>
                                                    <td>Add<a class="btn btn-success" type="add" onclick="addRow()"><i
                                                                class="bi bi-plus"></i></a></td>
                                                    <td>Supress<a class="btn btn-danger" type="delete"
                                                            onclick="removeRow(this)"><i class="bi bi-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <button type="submit" class="btn btn-primary" name="save"
                                            <?php include('fichier_include/insert.php');?>>Enregistrer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script src="assets/js/add_remove_updateStatus.js"></script>
    <script>
    $(document).ready(function() {
        $('#selectMembre').select2();
    });
    </script>
